...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡Join Our Main Channel ⚡", url='https://telegram.me/TV_Seriessss')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                return await query.answer('♥️ Thank You TV_Seriessss ♥️')
    ...
    if query.data.startswith("file"):
        ...
        await query.answer('♥️ Thank You TV_Seriessss ♥️')
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("Hey Bro! Please enter the official name 🤷‍♀️!\nPlease check your spelling once again 🤦‍♀️... or \n Discuss your problem with our admin here 👉 @Steve_4 ")
        await asyncio.sleep(8)
        await k.delete()
        return
